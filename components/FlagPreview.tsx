...
export function FlagPreview(p: Props) {
    return (
        <div className="h-full min-h-[260px] flex flex-col items-center justify-center gap-4 p-8 md:p-12">
            ...
            {!p.exporting && <p className="text-[11px] text-zinc-500 text-center">Tap an emblem to select (blue ring), then drag it anywhere. Tap x to remove. Tap the name above to rename.</p>}
        </div>
    );
}
